...
export default function Home(){
    return (
        <section id="home" className="w-full min-[430px]:h-[600px] h-screen bg-[url('/images/bg-home-2.png')] bg-cover bg-center pt-40 flex justify-center min-[430px]:p-0 pl-28 items-end">
